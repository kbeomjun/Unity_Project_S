...
public class DataManager : MonoBehaviour
{
    ...
    {
        new UnitData("Knight", UnitType.Knight, 90, 50, 1, 30, 0, 100, 100,
                        "Reduce 50% damage, Takes all attack"),
        new UnitData("Lancer", UnitType.Lancer, 70, 40, 2, 20, 0, 100, 100,
                        "Reflex 10 damage to attacker"),
        new UnitData("Archer", UnitType.Archer, 50, 30, 3, 10, 0, 100, 100,
                        "Increase attack 100%"),
