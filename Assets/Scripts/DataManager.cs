...
public class DataManager : MonoBehaviour
{
    ...
    {
        new UnitData("Knight", UnitType.Knight, 90, 10, 10, 30, 0, 100, 100,
                        "Reduce 50% damage, Takes all attack"),
        new UnitData("Lancer", UnitType.Lancer, 70, 10, 20, 20, 0, 100, 100,
                        "Reflex 10 damage to attacker"),
        new UnitData("Archer", UnitType.Archer, 50, 10, 30, 10, 0, 100, 100,
                        "Increase attack 100%"),
        new UnitData("Monk", UnitType.Monk, 30, 10, 5, 5, 0, 100, 100,
